...
@Injectable()
export class DeletedInvoicePublisher extends DeletedInvoiceEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedInvoicePublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedInvoicePublisher
   */
  constructor(
  ...
  /**
   *  El método emit en DeletedInvoicePublisher utiliza lastValueFrom de rxjs
