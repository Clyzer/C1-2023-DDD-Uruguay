...
import { EventEntity, OrderEntity } from '../../persistence/entities';

@Injectable()
export class DeletedOrderPublisher extends DeletedOrderEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedOrderPublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedOrderPublisher
   */
  constructor(
  ...
  /**
   *  El método emit en DeletedOrderPublisher utiliza lastValueFrom de rxjs
   ...
   * @memberof DeletedOrderPublisher
   */
  emit<Result = EventEntity, Input = OrderEntity>(
    pattern: EventEntity,
    data: Input,
  ): Promise<Result> {
