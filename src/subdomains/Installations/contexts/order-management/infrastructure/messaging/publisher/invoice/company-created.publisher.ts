...
@Injectable()
export class CreatedCompanyPublisher extends InvoiceCompanyCreatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of CreatedCompanyPublisher.
   * @param {ClientProxy} proxy
   * @memberof CreatedCompanyPublisher
   */
  constructor(
  ...
  /**
   * El método emit en CreatedCompanyPublisher utiliza lastValueFrom de rxjs
