...
@Injectable()
export class DeletedCompanyPublisher extends InvoiceCompanyDeletedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedCompanyPublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedCompanyPublisher
   */
  constructor(
  ...
  /**
   * El método emit en DeletedCompanyPublisher utiliza lastValueFrom de rxjs
