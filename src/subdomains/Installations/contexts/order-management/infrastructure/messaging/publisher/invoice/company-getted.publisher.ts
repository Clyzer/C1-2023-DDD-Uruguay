...
@Injectable()
export class GettedCompanyPublisher extends InvoiceCompanyGettedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of GettedCompanyPublisher.
   * @param {ClientProxy} proxy
   * @memberof GettedCompanyPublisher
   */
  constructor(
  ...
  /**
   * El método emit en GettedCompanyPublisher utiliza lastValueFrom de rxjs
