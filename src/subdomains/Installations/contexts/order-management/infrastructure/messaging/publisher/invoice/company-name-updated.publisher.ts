...
@Injectable()
export class NameUpdatedCompanyPublisher extends InvoiceCompanyNameUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of NameUpdatedCompanyPublisher.
   * @param {ClientProxy} proxy
   * @memberof NameUpdatedCompanyPublisher
   */
  constructor(
  ...
  /**
   * El método emit en NameUpdatedCompanyPublisher utiliza lastValueFrom de rxjs
