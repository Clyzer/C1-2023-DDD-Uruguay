...
@Injectable()
export class CreatedFeePublisher extends InvoiceFeeCreatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of CreatedFeePublisher.
   * @param {ClientProxy} proxy
   * @memberof CreatedFeePublisher
   */
  constructor(
  ...
  /**
   * El método emit en CreatedFeePublisher utiliza lastValueFrom de rxjs
