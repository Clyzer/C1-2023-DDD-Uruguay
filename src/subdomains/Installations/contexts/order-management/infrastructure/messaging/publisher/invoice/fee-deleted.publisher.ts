...
@Injectable()
export class DeletedFeePublisher extends InvoiceFeeDeletedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedFeePublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedFeePublisher
   */
  constructor(
  ...
  /**
   * El método emit en DeletedFeePublisher utiliza lastValueFrom de rxjs
