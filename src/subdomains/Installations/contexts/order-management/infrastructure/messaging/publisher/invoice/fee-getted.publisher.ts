...
@Injectable()
export class GettedFeePublisher extends InvoiceFeeGettedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of GettedFeePublisher.
   * @param {ClientProxy} proxy
   * @memberof GettedFeePublisher
   */
  constructor(
  ...
  /**
   * El método emit en GettedFeePublisher utiliza lastValueFrom de rxjs
