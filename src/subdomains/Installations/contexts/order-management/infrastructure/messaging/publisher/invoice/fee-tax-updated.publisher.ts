...
@Injectable()
export class TaxUpdatedFeePublisher extends InvoiceFeeTaxUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of TaxUpdatedFeePublisher.
   * @param {ClientProxy} proxy
   * @memberof TaxUpdatedFeePublisher
   */
  constructor(
  ...
  /**
   * El método emit en TaxUpdatedFeePublisher utiliza lastValueFrom de rxjs
