...
@Injectable()
export class InvoiceStatusChangedPublisher extends InvoiceStatusChangedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of InvoiceStatusChangedPublisher.
   * @param {ClientProxy} proxy
   * @memberof InvoiceStatusChangedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en InvoiceStatusChangedPublisher utiliza lastValueFrom de rxjs
