...
import { OrderBenefitedAddressUpdatedEventPublisherBase } from '../../../../domain/events/publishers/order';
import { BenefitedEntity, EventEntity } from '../../../persistence/entities';

@Injectable()
export class AddressUpdatedBenefitedPublisher extends OrderBenefitedAddressUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of AddressUpdatedBenefitedPublisher.
   * @param {ClientProxy} proxy
   * @memberof AddressUpdatedBenefitedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en AddressUpdatedBenefitedPublisher utiliza lastValueFrom de rxjs
