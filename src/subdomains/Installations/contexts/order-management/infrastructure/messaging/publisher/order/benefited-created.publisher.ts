...
@Injectable()
export class CreatedBenefitedPublisher extends OrderBenefitedCreatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of CreatedBenefitedPublisher.
   * @param {ClientProxy} proxy
   * @memberof CreatedBenefitedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en CreatedBenefitedPublisher utiliza lastValueFrom de rxjs
