...
@Injectable()
export class DeletedBenefitedPublisher extends OrderBenefitedDeletedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedBenefitedPublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedBenefitedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en DeletedBenefitedPublisher utiliza lastValueFrom de rxjs
