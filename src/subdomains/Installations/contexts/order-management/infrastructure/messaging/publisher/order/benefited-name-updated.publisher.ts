...
import { OrderBenefitedNameUpdatedEventPublisherBase } from '../../../../domain/events/publishers/order';
import { BenefitedEntity, EventEntity } from '../../../persistence/entities';

@Injectable()
export class NameUpdatedBenefitedPublisher extends OrderBenefitedNameUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of NameUpdatedBenefitedPublisher.
   * @param {ClientProxy} proxy
   * @memberof NameUpdatedBenefitedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en NameUpdatedBenefitedPublisher utiliza lastValueFrom de rxjs
