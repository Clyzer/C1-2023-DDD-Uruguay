...
@Injectable()
export class PhoneUpdatedBenefitedPublisher extends OrderBenefitedPhoneUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of PhoneUpdatedBenefitedPublisher.
   * @param {ClientProxy} proxy
   * @memberof PhoneUpdatedBenefitedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en PhoneUpdatedBenefitedPublisher utiliza lastValueFrom de rxjs
