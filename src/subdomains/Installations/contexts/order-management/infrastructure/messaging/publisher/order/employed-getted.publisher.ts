...
@Injectable()
export class GettedEmployedPublisher extends OrderEmployedGettedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of GettedEmployedPublisher.
   * @param {ClientProxy} proxy
   * @memberof GettedEmployedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en GettedEmployedPublisher utiliza lastValueFrom de rxjs
