...
@Injectable()
export class NameUpdatedEmployedPublisher extends OrderEmployedNameUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of NameUpdatedEmployedPublisher.
   * @param {ClientProxy} proxy
   * @memberof NameUpdatedEmployedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en NameUpdatedEmployedPublisher utiliza lastValueFrom de rxjs
