...
@Injectable()
export class PhoneUpdatedEmployedPublisher extends OrderEmployedPhoneUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of PhoneUpdatedEmployedPublisher.
   * @param {ClientProxy} proxy
   * @memberof PhoneUpdatedEmployedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en PhoneUpdatedEmployedPublisher utiliza lastValueFrom de rxjs
