...
@Injectable()
export class DeletedKitPublisher extends OrderKitDeletedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of DeletedKitPublisher.
   * @param {ClientProxy} proxy
   * @memberof DeletedKitPublisher
   */
  constructor(
  ...
  /**
   * El método emit en DeletedKitPublisher utiliza lastValueFrom de rxjs
