...
@Injectable()
export class GettedKitPublisher extends OrderKitGettedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of GettedKitPublisher.
   * @param {ClientProxy} proxy
   * @memberof GettedKitPublisher
   */
  constructor(
  ...
  /**
   * El método emit en GettedKitPublisher utiliza lastValueFrom de rxjs
