...
import { OrderKitModelUpdatedEventPublisherBase } from '../../../../domain/events/publishers/order';
import { EventEntity, KitEntity } from '../../../persistence/entities';

@Injectable()
export class ModelUpdatedKitPublisher extends OrderKitModelUpdatedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of ModelUpdatedKitPublisher.
   * @param {ClientProxy} proxy
   * @memberof ModelUpdatedKitPublisher
   */
  constructor(
  ...
  /**
   * El método emit en ModelUpdatedKitPublisher utiliza lastValueFrom de rxjs
