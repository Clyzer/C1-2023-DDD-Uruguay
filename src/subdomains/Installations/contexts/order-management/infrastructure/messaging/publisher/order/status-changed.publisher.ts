...
@Injectable()
export class OrderStatusChangedPublisher extends OrderStatusChangedEventPublisherBase {
  /**
   ...
   *
   * Creates an instance of OrderStatusChangedPublisher.
   * @param {ClientProxy} proxy
   * @memberof OrderStatusChangedPublisher
   */
  constructor(
  ...
  /**
   * El método emit en OrderStatusChangedPublisher utiliza lastValueFrom de rxjs
